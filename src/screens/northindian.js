    ...
    {/* taping names like veg, nin-veg etc................. */}
      ...
      <ScrollView style={{marginBottom:"100%",marginTop:11}}><TouchableOpacity style={{justifyContent:"center"}}>
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:10,height:160,width:130, marginTop:10,marginBottom:20, marginLeft:18}}source={require('../assets/1north.jpg')}></Image>
      ...
      <TouchableOpacity style={{backgroundColor:"white"}} >
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:10,height:160,width:130, marginTop:10,marginBottom:20, marginLeft:18}}source={require('../assets/2north.jpg')}></Image>
         <View style={{borderBottomWidth:.5,bottom:50,left:10,borderBottomColor:"gray"}}>
      ...
      <TouchableOpacity style={{backgroundColor:"white"}} >
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:10,height:160,width:130, marginTop:10,marginBottom:20, marginLeft:18}}source={require('../assets/3north.jpg')}></Image>
         <View style={{borderBottomWidth:.5,bottom:50,left:10,borderBottomColor:"gray"}}>
          <Text style={{top:76,fontWeight:"bold", fontSize:15,fontStyle:"normal",paddingTop:8}}>
            Empire Plaza {'                                     '}{'\n'}
          </Text>
      ...
      <TouchableOpacity style={{backgroundColor:"white"}} >
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:10,height:160,width:130, marginTop:10,marginBottom:20, marginLeft:18}}source={require('../assets/4north.jpg')}></Image>
         <View style={{borderBottomWidth:.5,bottom:50,left:10,borderBottomColor:"gray"}}>
          <Text style={{top:76,fontWeight:"bold", fontSize:15,fontStyle:"normal",paddingTop:8}}>
            Paragon {'                                           '}{'\n'}
          </Text>
      ...
      <TouchableOpacity style={{backgroundColor:"white"}} >
       ...
       <View style={{flexDirection:"row",}}>
          ...
          <Image style={{borderRadius:10,height:160,width:130, marginTop:10,marginBottom:20, marginLeft:18}}source={require('../assets/5north.jpg')}></Image>
         <View style={{borderBottomWidth:.5,bottom:50,left:10,borderBottomColor:"gray"}}>
          <Text style={{top:76,fontWeight:"bold", fontSize:15,fontStyle:"normal",paddingTop:8}}>
            Ifthar {'                                                '}{'\n'}
          </Text>
